# elections_lk.core (auto generate by build_inits.py)
...
from elections_lk.core.election import (
    Election,
    ElectionBase,
    ElectionGIGData,
)
...
from elections_lk.core.raw_data import (
    RawData,
)

from elections_lk.core.result import (
    PartyToSeats,
    PartyToVotes,
    Result,
    ResultWithSeats,
